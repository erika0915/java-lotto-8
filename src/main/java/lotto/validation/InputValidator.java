...
public class InputValidator {
    ...
    private int validateNumeric(String input, String errorMessage){
        try {
    ...
    private void validateWinningNumberCount(String[] numberString){
    ...
    private void validateBonusNotInWinningNumbers(int bonusNumber, List<Integer> winningNumbers){
